...
/**
 * @description adds an event listener to the onBeforeSendHeaders
 */
...
/**
 * @description event listener called when postman sends a request (in the form of a message)
 */
chrome.runtime.onMessageExternal.addListener(onExternalMessage);

/**
 * @description event listener called for each request to intercept - used to intercept request data
 */
...
/**
 * @description event listener called just before sending - used for getting headers
 */
...
/**
 * @description creates a context menu link to import curl
 */
